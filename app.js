const baseGames = [
  ...
  { id:"g41", title: "Buz Küpü Eriyene Kadar 🧊", duration: "15", place: "ev", material: "var", skill: "Sabır + Isı Farkındalığı", steps: ["Buzluktan küçük bir buz küpü alıp çocuğun avucuna veya tabağa koyun.", "Çocuğa buzun kendi kendine tamamen suya dönüşene kadar birlikte bekleyeceğinizi söyleyin.", "Beklerken su döngüsü üzerine basit hayaller kurun veya suların nereye gittiğini konuşun."], safety: "Buz avucu çok üşütüp acıtmaması için ufak aralıklarla el değiştirin." },
  ...
  { id:"g80", title: "Merdiven Bowling 🎳", duration: "15", place: "ev", material: "var", skill: "Nişan Alma", steps: ["Koridorun sonuna 6-10 boş plastik su şişesi piramit şeklinde dizin.", "Yumuşak bir topla birkaç metre uzaktan yuvarlatarak devrilenleri sayın.", "3 tur yapıp toplam skoru hesaplayın. Kazanan çak-bes alır!"], safety: "Cam şişe asla kullanmayın, sadece plastik kullanın." },
...
function buildObserverSteps(rawSteps, game) {
  ...
  const isEditorialAll = getGameNumericId(game) <= 200;
  if (isEditorialAll) {
    return [
